...
export const REF_BS = { year: 2000, month: 1, day: 1 };
export const REF_AD = new Date(1943, 3, 14);
 ...
 */
export const BS_CALENDAR_DATA: Record<number, [number[], number]> = {
